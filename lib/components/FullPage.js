...
var FullPage = (function(_React$Component) {
  ...
  function FullPage(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (FullPage.__proto__ || Object.getPrototypeOf(FullPage)).call(this, props)
    );
    ...
    _this.slidesCount = _react2.default.Children.toArray(props.children).filter(
      function(child) {
        return child.type.displayName !== 'ControlledComponent';
      }
    ).length;
    _this.slideElements = _react2.default.Children.toArray(
      props.children
